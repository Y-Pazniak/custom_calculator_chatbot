...
public class UserProgressManager {
    ...
    private void processSelfPropelledPower(final UserProgress userProgress, final Command requestingCommand, final String chatID) throws UtilsborException {
        ...
        switch (requestingCommand) {
            ...
            case Command.POWER_LESS_170 -> userProgress.setSelfPropelledPower(SelfPropelledPower.LESS_170);
            case Command.POWER_170_250 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_170_250);
            case Command.POWER_MORE_250 -> userProgress.setSelfPropelledPower(SelfPropelledPower.MORE_250);

            case Command.POWER_100_125 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_100_125);
            case Command.POWER_125_150 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_125_150);
            case Command.POWER_MORE_150 -> userProgress.setSelfPropelledPower(SelfPropelledPower.MORE_150);
            ...
            case Command.POWER_5_50 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_5_50);
            ...
            case POWER_BETWEEN_20_100 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_20_100);
            case POWER_BETWEEN_100_300 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_100_300);

            case POWER_BETWEEN_5p5_30 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_5p5_30);
            case POWER_BETWEEN_30_60 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_30_60);
            case POWER_BETWEEN_60_90 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_60_90);
            case POWER_BETWEEN_90_130 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_90_130);
            case POWER_BETWEEN_130_180 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_130_180);
            case POWER_BETWEEN_180_220 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_180_220);
            case POWER_BETWEEN_220_280 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_220_280);
            ...
            case POWER_LESS_295 -> userProgress.setSelfPropelledPower(SelfPropelledPower.LESS_295);
            case POWER_BETWEEN_295_401 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_295_401);
            case POWER_MORE_401 -> userProgress.setSelfPropelledPower(SelfPropelledPower.MORE_401);

            case POWER_BETWEEN_100_120 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_100_120);
            case POWER_BETWEEN_120_300 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_120_300);
            case SELF_PROPELLED_MOWERS -> userProgress.setSelfPropelledPower(SelfPropelledPower.SELF_PROPELLED_MOWERS);

            case POWER_LESS_200 -> userProgress.setSelfPropelledPower(SelfPropelledPower.LESS_200);
            case POWER_BETWEEN_200_650 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_200_650);
            case POWER_BETWEEN_650_1750 -> userProgress.setSelfPropelledPower(SelfPropelledPower.BETWEEN_650_1750);
            case POWER_MORE_1750 -> userProgress.setSelfPropelledPower(SelfPropelledPower.MORE_1750);
        }
        userProgressStorage.save(userProgress);
    }
    ...
    public String processSelfPropelledType(final Command requestingCommand, final String chatID) throws UtilsborException {
        ...
        switch (requestingCommand) {
            ...
            case EXCAVATORS -> userProgress.setSelfPropelledType(SelfPropelledType.EXCAVATOR);
            ...
            case FORAGE_HARVESTERS -> userProgress.setSelfPropelledType(SelfPropelledType.FORAGE_HARVESTERS);
            case AGRICULTURAL_VEHICLES -> userProgress.setSelfPropelledType(SelfPropelledType.AGRICULTURAL_VEHICLES);
            case OFF_ROAD_DUMP_TRUCKS -> userProgress.setSelfPropelledType(SelfPropelledType.OFF_ROAD_DUMP_TRUCKS);
        }
