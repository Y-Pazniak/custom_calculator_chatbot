...
public enum Command {
    ...
    //power of graders
    POWER_LESS_100("/less_100", SELF_PROPELLED_POWER),
    POWER_100_140("/between_100_140", SELF_PROPELLED_POWER),
    POWER_140_200("/between_140_200", SELF_PROPELLED_POWER),
    POWER_MORE_200("/more_200", SELF_PROPELLED_POWER),

    //power of bulldozers
    POWER_100_200("/between_100_200", SELF_PROPELLED_POWER),
    POWER_200_300("/between_200_300", SELF_PROPELLED_POWER),
    POWER_300_400("/between_300_400", SELF_PROPELLED_POWER),
    POWER_MORE_400("/more_400", SELF_PROPELLED_POWER),

    //power of excavators
    POWER_LESS_170("/less_170", SELF_PROPELLED_POWER),
    POWER_170_250("/between_170_250", SELF_PROPELLED_POWER),
    POWER_MORE_250("/more_250", SELF_PROPELLED_POWER),

    //power of wheel loaders
    POWER_100_125("/between_100_125", SELF_PROPELLED_POWER),
    POWER_125_150("/between_125_150", SELF_PROPELLED_POWER),
    POWER_MORE_150("/more_150", SELF_PROPELLED_POWER),

    //power of tamping machines
    POWER_LESS_40("/less_40", SELF_PROPELLED_POWER),
    POWER_40_80("/between_40_80", SELF_PROPELLED_POWER),
    POWER_MORE_80("/more_80", SELF_PROPELLED_POWER),

    //power of front loaders
    POWER_5_50("/between_5p5_50", SELF_PROPELLED_POWER),
    POWER_50_100("/between_50_100", SELF_PROPELLED_POWER),
    POWER_200_250("/between_200_250", SELF_PROPELLED_POWER),
    POWER_250_300("/between_250_300", SELF_PROPELLED_POWER),

    //power of pipelayers
    POWER_LESS_130("/less_130", SELF_PROPELLED_POWER),
    POWER_130_200("/between_130_200", SELF_PROPELLED_POWER),
    POWER_MORE_300("/more_300", SELF_PROPELLED_POWER),

    //type of trailers
    TRAILERS_OTHER_FULL("/trailers", SELF_PROPELLED_POWER),
    TRAILERS_OTHER_HALF("/half_trailers", SELF_PROPELLED_POWER),

    //power of road maintenance
    POWER_BETWEEN_100_220("/between_100_220", SELF_PROPELLED_POWER),
    POWER_MORE_220("/more_220", SELF_PROPELLED_POWER),

    //power of forestry
    POWER_BETWEEN_20_100("/between_20_100",SELF_PROPELLED_POWER),
    POWER_BETWEEN_100_300("/between_100_300", SELF_PROPELLED_POWER),

    //power of wheeled tractors
    POWER_BETWEEN_5p5_30("/between_5p5_30",SELF_PROPELLED_POWER),
    POWER_BETWEEN_30_60("/between_30_60", SELF_PROPELLED_POWER),
    POWER_BETWEEN_60_90("/between_60_90",SELF_PROPELLED_POWER),
    POWER_BETWEEN_90_130("/between_90_130", SELF_PROPELLED_POWER),
    POWER_BETWEEN_130_180("/between_130_180",SELF_PROPELLED_POWER),
    POWER_BETWEEN_180_220("/between_180_220", SELF_PROPELLED_POWER),
    POWER_BETWEEN_220_280("/between_220_280",SELF_PROPELLED_POWER),
    POWER_BETWEEN_280_340("/between_280_340", SELF_PROPELLED_POWER),
    POWER_BETWEEN_340_380("/between_340_380",SELF_PROPELLED_POWER),
    POWER_MORE_380("/more_380", SELF_PROPELLED_POWER),

    //power of combine harvesters
    POWER_BETWEEN_25_160("/between_25_160",SELF_PROPELLED_POWER),
    POWER_BETWEEN_160_220("/between_160_220",SELF_PROPELLED_POWER),
    POWER_BETWEEN_220_255("/between_220_255",SELF_PROPELLED_POWER),
    POWER_BETWEEN_255_325("/between_255_325",SELF_PROPELLED_POWER),
    POWER_BETWEEN_325_400("/between_325_400",SELF_PROPELLED_POWER),

    //power of forage harvesters
    POWER_LESS_295("/less_295",SELF_PROPELLED_POWER),
    POWER_BETWEEN_295_401("/between_295_401",SELF_PROPELLED_POWER),
    POWER_MORE_401("/more_401",SELF_PROPELLED_POWER),

    //power of agricultural vehicles
    POWER_BETWEEN_100_120("/between_100_120",SELF_PROPELLED_POWER),
    POWER_BETWEEN_120_300("/between_120_300",SELF_PROPELLED_POWER),
    SELF_PROPELLED_MOWERS("/self_propelled_mowers",SELF_PROPELLED_POWER),

    //power of off-road dump trucks
    POWER_LESS_200("/less_200",SELF_PROPELLED_POWER),
    POWER_BETWEEN_200_650("/between_200_650",SELF_PROPELLED_POWER),
    POWER_BETWEEN_650_1750("/between_650_1750",SELF_PROPELLED_POWER),
    POWER_MORE_1750("/more_1750",SELF_PROPELLED_POWER);
